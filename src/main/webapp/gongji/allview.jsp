...
<body>
	...
	Pagination pagination = boardItemService.getPagination(pages,10,20,boardItemDao.countG());
	pageContext.setAttribute("pagination", pagination);
	List<BoardItem> boardItems  = boardItemDao.selectAllG(pages,20);
