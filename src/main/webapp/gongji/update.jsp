...
<div class="container-fluid">
    ...
    <table class="table table-bordered">
        <thead>
          <tr>
            <th colspan=2 width=500px>기존 글 수정</th>
        ...
        <tbody>
          ...
          <tr>
            <td colspan="3" height="200px"><textarea name="con" id="con" style="width: 100%; height: 100%;"><%=con %></textarea><input type="hidden" value=<%=rcount  %> id=rCount name=rCount></td>
