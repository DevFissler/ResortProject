...
<body>
    ...
    <table class="table table-bordered">
        <thead>
          <tr>
            <th colspan="3" width=500>글 자세히</th>
       
            <td><input type="button" value="목록" onClick="location.href='allview.jsp?page=1'" style="margin-left:80px ;margin-right: 20px;">
            <input type="button" value="댓글" onClick="location.href='reply.jsp?id=<%=rCount %>&rLevel=<%=rLevel+1 %>'" style="margin-right: 20px;">
            <input type="button" value="수정" onClick="location.href='update.jsp?id=<%=regNum %>'" style="margin-right: 20px;">
            </td>
          </tr>
        </thead>
        <tbody>
          ...
          <tr>
            <td colspan="4" height="130px"><textarea style="width: 100%; height: 100%" readonly ><%=info %></textarea></td>
          </tr>
        </tbody>
      </table>
      </div>
