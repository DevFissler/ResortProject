...
<body>
    ...
    <table class="table table-bordered">
        <thead>
          <tr>
            <th colspan="3" width=500>새 글 입력</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td colspan=3><input type="number" value="0" name="rLevel" id="rLevel" readonly>
 
 			<input type="hidden" value="<%=newId+".0" %>" name="rCount" id="rCount" readonly></td>
          </tr>
          <tr>
